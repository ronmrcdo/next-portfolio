      ...
      <section className="relative w-full px-8">
        <div className="container mx-auto pt-10 max-w-7xl px-20">
          ...
          <p className="text-gray-700 py-10 w-2/3">
           I practice the habit of learning and adapting in the fast-paced changes in technology. 
           I have a background with CI/CD and also applying the best practices and technologies to my software development career. 
          </p>
          <div className="block">
